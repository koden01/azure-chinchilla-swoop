        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
          <div>
            ...
            <Select onValueChange={setExpedition} value={expedition}>
              <SelectTrigger className="w-full bg-white text-gray-800 h-20 text-center"> {/* Added text-center */}
          ...
          <div className="md:col-span-2">
            ...
            <Input
              ...
              ref={resiInputRef}
              className="w-full bg-white text-gray-800 h-40 text-2xl text-center" {/* Added text-center */}
